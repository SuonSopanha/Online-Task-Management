...
const Navbar = ({ toggleSidebar , isOpen }) => {
  ...
  return (
    <header className="bg-blue-100 fixed top-0 left-0 right-0 z-50">
      <nav className="flex justify-between bg-glasses backdrop-blur-12 text-blue-500 w-screen h-12">
        ...
        <div className="px-5 xl:px-12 py-3 flex w-full items-center ">
          <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
            <div className="relative border-2 border-gray-50 px-3 py-1 rounded-lg full bg-white sm:w-64 md:w-80">
